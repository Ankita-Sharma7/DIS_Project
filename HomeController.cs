...
namespace DataGov_API_Intro_6.Controllers
{
    public class HomeController : Controller
    {
        ...
        static string API_KEY = "b5abe19835msh67f81595844d811p1fca5cjsnfb9847db39b8"; //Add your API key here inside ""
...
{ "X-RapidAPI-Key", "1333fc7156msh6301fba68750a93p1f60e1jsnd8ef9c3b7ce1" },
},
            };
        ...
        public IActionResult addMovie(string imdbid, string title, string genres, float imdbrating, int released, 
                                              string synopsis, string type)
        {
            try
            {
               // string[] ChartColors = new string[] { "#C70039", "#55CAA2", "#283980" };
                ...
                if (imdbid != null)
                {
                   Result r = new Result(imdbid, title, genres, imdbrating, released, synopsis, type)
                    {
                        imdbid = imdbid,
                        title = title,
                    ...
                    dbContext.Result.Add(r);
                    dbContext.SaveChanges();
                    ViewBag.Message = String.Format("Movie Added for ImdbID " + imdbid );
                }
